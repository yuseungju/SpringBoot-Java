							...
							<div class="container">
								<div class="list_header">
									...
									<div class="sort" id ="page_num_select">
										<a href="#count_list" onclick ="changePageNum(); return false;" class="sort_title" id ="page_num_title">3개씩</a>
										<div id="count_list" class="dropdown">
											<ul class="drop_item">
												<li><a href="#" class = page_num_li><span>3개씩</span></a></li>
...
<script>
	...
	var num_per_page = 3;//페이지당 방 출력 개수
	...
	function setInfor(data){ 
		...
		for(var a= 0; a <data.roomList.length; a++){
			...
			str+="				<a href=\"수정하기\">수정</a>";
			str+="			</p>";
			str+="			<p class=\"btn copy_btn\">";
			str+="				<a href=\"복사하기\">복사</a>";
			str+="			</p>";
			str+="		</td>";
			str+="	</tr>";
		}
