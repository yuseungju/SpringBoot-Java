			...
			<div class="page">
				<form action="/join/user" method="POST" name="joinForm">
						...
						<div class="row">
							<div class="container">
								...
								<ul class="member_category ">
									<li class="col3 fl type1  current"><span class="text">일반회원</span><span
										class="bullet"></span></li>
									<li class="col3 fl type2  "><a href="/join/lessor"
										title="임대인회원가입"><span class="text">임대인회원</span></a><span
										class="bullet"></span></li>
					...
					<div class="join_body container">
						<div class="box">
							<p class="tit">간단 회원가입</p>
							<div class="row panel">
								<div class="social_button">
									<p class="first">
										<a href="#" onClick="loginWithFacebook();return false;"
											class="btn btn_facebook"><span class="icon_facebook icon">페이스북계정으로
												시작하기</span></a>
									</p>
									<p>
										<a href="#" onClick="loginWithKakao();return false;"
											class="btn btn_kakao"><span class="icon_kakao icon">카카오톡계정으로
												시작하기</span></a>
									</p>
								</div>
							</div>
						...
						<div class="box">
							<div class="row  e-join">
								<p class="tit">이메일로 회원가입</p>
							</div>
							<div class="panel">
								<div class="row form_group">
									<label for="input_name" class="col_label">이름</label>
									<div class="input text col_wide fl">
										<span class="form-control"><input class="bor_input"
											type="text" name="name" id="input_name"
								...
								<div class="row form_group">
									...
									<div class="input text  fl col_mid">
										<span class="form-control"><input type="text"
											id="input_collect" class="bor_input" placeholder="인증번호를 입력하세요" /></span>
