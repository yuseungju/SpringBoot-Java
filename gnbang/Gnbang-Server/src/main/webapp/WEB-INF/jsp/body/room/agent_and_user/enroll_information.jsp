...
<!-- <body class="room sub agent"> -->
	...
	<input id="upload_file" type="file" name="uploadFile" accept="*" style='display: none;' onchange="selectUploadPhoto(this);" />
	</form>
...
<script>
	...
	function setAddressAtr(){
		...
		formData["new_address"] = "${postAddress.new_address}";
