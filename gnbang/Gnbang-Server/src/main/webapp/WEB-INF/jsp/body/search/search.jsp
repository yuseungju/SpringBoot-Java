                  ...
                  <div class="row ">
                    <div>
                      ...
                      <div class="filter_item col5 sm_col3 check">
                        ...
                        <div class="filter_item col5 sm_col3 check"  style="display:none;">
                          <div class="inner">
                            <label  >
                              <span class="input">
                                <input type="checkbox" name ="add_option" id="sale" checked/>
                              </span>
                              <span class="txt">
                                매물
                              </span> </label>
...
/* 		//마커표시할 데이터 초기화
		...
		for(var a= 0; a < data.roomList.length ; a++){
	        ...
	        str += "      <li>";
	        str += "<a href=\"#\" onclick =\"clickRoomDetail("+no+");\" class=\"media_photo media_cover\" value =\""+no+"\">";
	        ...
	        str += "    </div><!-- inner마감-->";
	        str += " </div><!-- thum마감-->";
	        str += "      <div class=\"info_grounp\" onclick =\"clickRoomDetail("+no+");\">";
	        str += "        <div class=\"inner\">";
	        ...
	        if( <%=request.isUserInRole("ROLE_AGENT") %>){//중개사, 일반,임대인로그인 경우만 zzim여부표시 --%>
		        ...
		        str += "       <div class=\"input\"><input type=\"checkbox\" onclick =\"event.stopPropagation();\" value=\"" + no + "\" name=\"interest_room_no\" /> </div><!-- input마감-->";
