				...
				<div class="panel">
					<div class="content_header room_header">
						<div class="container">
							<div class="inner">
								<div class="pic">
									<p>
										<img src="${pageContext.request.contextPath}/images/common/account50_mint.png" id ="profile" alt="중개사" />
									</p>
									<p class="name">최은정님</p>
									<p class="desc">
					...
					<div class="content_body">
						...
						<ul class="tab_list">
							...
							<li><p>
									<a href="/room/waitPermission">승인 대기(<span>1</span>)
									</a>
								</p></li>
							<li><p>
									<a href="/room/notPermission">승인 반려(<span>0</span>)
									</a>
								</p></li>
						</ul>
									...
									<tbody>
										<tr>
												...
												<div class="image_list">
													<div class="media_photo media_cover">
														<div class="media_cover">
															<img src="photo/sample/thumb.jpg" alt="2003번 방사진"
																class="img_responsive_height" />
														</div>
													</div>
												</div>
											</td>
											<td class="col_desc  m_no_col">
												...
												<div class="row">
													<p class="col_sm  fl">
														<span class="tit">매물번호</span> <span>12345</span>
													</p>
													<p class="col_sm fl">
