...
<%@ taglib prefix="sec"
	...
	<div class="my_sidebar box fl">
		<ul class="lnb">
			...
			<li id="select_zzim"><a href="/room/zzim"><span>찜한방 </span></a></li>
			<li id="select_recent"><a href="/room/recently"><span>내가 본 방</span></a></li>
			<sec:authorize access="hasRole('ROLE_AGENT')">
			<li id="select_hardware_enroll" class="last"><a href="/member/agent/hardware_enroll"><span>사용기기 등록</span></a></li>
			</sec:authorize>
		</ul>
	</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#select_hardware_enroll").removeClass('current');
	...
	function setCurrentMenu(){
		...
		if('${selectPage}' == 'password')
			...
			$("#select_interest").addClass('first current');
		else if('${selectPage}' == 'hardware_enroll')
			$("#select_hardware_enroll").addClass('first current');
	}
</script>