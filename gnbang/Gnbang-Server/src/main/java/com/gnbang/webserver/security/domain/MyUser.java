...
public class MyUser implements UserDetails, CredentialsContainer {
	...
	private String enrollMacAddress;//사용 pc 맥주소
	 ...
	 * {@code true}.
	 */
	public MyUser(String username, String password, String realname, Integer no, Integer level,
			Integer type, String date, String enrollMacAddress, Collection<? extends GrantedAuthority> authorities) {
		this(username, password, realname, no, level, type, date, enrollMacAddress, true, true, true, true, authorities);
	}
	 ...
	 */
	public MyUser(String username, String password, String realname, Integer no, Integer level,
			Integer type, String date, String enrollMacAddress, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired,
		...
		this.level = level;
		this.type = type;
		this.enrollMacAddress = enrollMacAddress;
	...
	public String getEnrollMacAddress() {
		return enrollMacAddress;
	}

	public void setEnrollMacAddress(String enrollMacAddress) {
		this.enrollMacAddress = enrollMacAddress;
	}
